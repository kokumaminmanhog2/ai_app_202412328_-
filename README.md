...
| ③ | **담당 교수 이메일** | 제출 알림 — 제목 `[AI응용] 과제N_학번_이름`, **본문에 GitHub 저장소 링크 포함** |

> **GitHub 사용이 어렵다면**: `.ipynb` 파일을 이메일에 **첨부**해 제출해도 동일하게 인정합니다(감점 없음). 이 경우에도 e-Campus 제출은 필요합니다. 다만 GitHub으로 제출하는 쪽을 권장합니다 — 아래 이유 때문입니다.
